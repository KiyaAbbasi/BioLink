...
class SearchWP_Live_Search_Menu {
	...
	public function add_menus_searchwp_enabled( $submenu_pages ) {
		...
		$submenu_pages['live-search'] = [
			'menu_title' => esc_html__( 'Live Search', BIO_PLUGIN_NAME ),
    ...
    public function add_menus_searchwp_disabled() {
	    ...
	    $page_title = esc_html__( 'SearchWP', BIO_PLUGIN_NAME );
		$settings   = searchwp_live_search_bio()->get( 'Settings' );
	    ...
	    add_submenu_page(
		    self::MENU_SLUG,
		    $page_title,
		    esc_html__( 'Live Search', BIO_PLUGIN_NAME ),
		    SearchWP_Live_Search_Settings_Api::CAPABILITY,
		    self::MENU_SLUG,
		    [ $settings, 'page_searchwp_disabled' ]
	    );
	...
	public function add_upgrade_pro_link_searchwp_disabled() {
		...
		add_submenu_page(
			self::MENU_SLUG,
			esc_html__( 'Upgrade to Pro', BIO_PLUGIN_NAME ),
			esc_html__( 'Upgrade to Pro', BIO_PLUGIN_NAME ),
			SearchWP_Live_Search_Settings_Api::CAPABILITY,
